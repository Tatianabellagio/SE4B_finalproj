...
test_that("columns have correct data type", {
  expect_true(typeof(buttR_neuro$count) == "double")
  expect_true(typeof(buttR_neuro$gene) == "integer")
  expect_true(typeof(buttR_neuro$sample) == "integer")
  expect_true(typeof(buttR_neuro$individual) == "integer")
  expect_true(typeof(buttR_neuro$sex) == "integer")
  expect_true(typeof(buttR_neuro$species) == "integer")
  expect_true(typeof(buttR_neuro$social) == "integer")
  expect_true(typeof(buttR_neuro$region_mammal) == "integer")
})

test_that("columns have correct class", {
  expect_true(class(buttR_neuro$count) == "numeric")
  expect_true(class(buttR_neuro$gene) == "factor")
  expect_true(class(buttR_neuro$sample) == "integer")
  expect_true(class(buttR_neuro$individual) == "factor")
  expect_true(class(buttR_neuro$sex) == "factor")
  expect_true(class(buttR_neuro$species) == "factor")
  expect_true(class(buttR_neuro$social) == "factor")
  expect_true(class(buttR_neuro$region_mammal) == "factor")
})
